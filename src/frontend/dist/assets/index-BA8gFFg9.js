...
const SEMESTERS = Array.from({ length: 11 }, (_, i) => i + 1);
const semesterLabel = (n) => `${n}${n === 1 ? "st" : n === 2 ? "nd" : n === 3 ? "rd" : "th"} Semester`;
const defaultSemesterCodes = {
  1: "ALA-SEM-01-2846",
  2: "ALA-SEM-02-5931",
  3: "ALA-SEM-03-7184",
  4: "ALA-SEM-04-4629",
...
const LOGO_SRC = "/assets/uploads/screenshot_2026-03-23_142959-019d1e76-58ac-71ac-aa59-99917cdecdb1-1.png";
function Card({
  title,
  subtitle,
  children,
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
          ...
          subtitle ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-slate-500", children: subtitle }) : null
        ] }),
        children
      ]
    }
...
function TabButton({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      type: "button",
      onClick,
      className: `rounded-full px-4 py-2 text-sm font-medium transition-all ${active ? "bg-amber-600 text-white shadow-md shadow-amber-200" : "bg-white text-slate-700 border border-slate-200 hover:bg-amber-50 hover:border-amber-300 hover:text-amber-800"}`,
      children
    }
  );
}
function App() {
  ...
  const [db, setDb] = reactExports.useState(initialState());
  const [role, setRole] = reactExports.useState(null);
  const [session, setSession] = reactExports.useState(null);
  const [loginMode, setLoginMode] = reactExports.useState("teacher");
  const [activeTab, setActiveTab] = reactExports.useState("dashboard");
  const [selectedSemester, setSelectedSemester] = reactExports.useState(1);
  const [teacherUsername, setTeacherUsername] = reactExports.useState(TEACHER_USERNAME);
  const [teacherPassword, setTeacherPassword] = reactExports.useState(TEACHER_PASSWORD);
  const [studentId, setStudentId] = reactExports.useState("");
  const [studentCode, setStudentCode] = reactExports.useState("");
  const [newStudent, setNewStudent] = reactExports.useState({
    name: "",
    semester: 1,
    code: ""
  });
  const [newRoutine, setNewRoutine] = reactExports.useState({
    day: "Mon",
    time: "10:00 AM",
    subject: "",
    topic: ""
  });
  const [newRecording, setNewRecording] = reactExports.useState({
    subject: "",
    chapter: "",
    title: "",
    url: ""
  });
  const [newMaterial, setNewMaterial] = reactExports.useState({
    subject: "",
    title: "",
    type: "PDF",
    url: ""
  });
  const [inLiveRoom, setInLiveRoom] = reactExports.useState(false);
  const [cameraOn, setCameraOn] = reactExports.useState(false);
  const [micOn, setMicOn] = reactExports.useState(false);
  const [screenSharing, setScreenSharing] = reactExports.useState(false);
  const [chatInput, setChatInput] = reactExports.useState("");
  const [localStream, setLocalStream] = reactExports.useState(null);
  const [screenStream, setScreenStream] = reactExports.useState(null);
  const [mediaRecorder, setMediaRecorder] = reactExports.useState(
    null
  );
  const [isRecording, setIsRecording] = reactExports.useState(false);
  const [newLiveTitle, setNewLiveTitle] = reactExports.useState("");
  ...
  const currentStudent = reactExports.useMemo(() => {
    if (role !== "student" || !session) return null;
    return db.students.find((s) => s.id === session.studentId) || null;
  }, [db.students, role, session]);
  const mySemester = (currentStudent == null ? void 0 : currentStudent.semester) || selectedSemester;
  const loginTeacher = () => {
    if (teacherUsername === TEACHER_USERNAME && teacherPassword === TEACHER_PASSWORD) {
      setRole("teacher");
  ...
  const loginStudent = () => {
    const found = db.students.find(
      (s) => s.id.trim().toUpperCase() === studentId.trim().toUpperCase() && s.code === studentCode.trim()
    );
    if (!found) {
  ...
  const addStudent = () => {
    ...
    const code = (newStudent.code || `STU-${Math.random().toString(36).slice(2, 8).toUpperCase()}`).trim();
    setDb((prev) => ({
      ...prev,
      students: [
        ...prev.students,
  ...
  const updateSemesterCode = (sem, value) => {
    setDb((prev) => ({
      ...prev,
  ...
  const saveRecordingToDb = (sem, title, blobUrl) => {
    setDb((prev) => ({
      ...prev,
      recordings: {
        ...prev.recordings,
  ...
  const toggleScreenShare = async () => {
    ...
    if (screenSharing) {
      ...
      try {
        ...
        (_a2 = stream.getVideoTracks()[0]) == null ? void 0 : _a2.addEventListener("ended", () => {
          setScreenStream(null);
          setScreenSharing(false);
        });
  ...
  const startLiveClass = () => {
    ...
    const session2 = {
      ...
      isActive: true,
      startedAt: (/* @__PURE__ */ new Date()).toLocaleTimeString(),
      participants: [
    ...
    setDb((prev) => ({
      ...prev,
      liveClasses: { ...prev.liveClasses, [sem]: session2 }
    }));
    setNewLiveTitle("");
    setInLiveRoom(true);
  };
  const joinLiveClass = () => {
    ...
    const liveSession2 = db.liveClasses[sem];
    if (!liveSession2) return;
    if (role === "student" && currentStudent) {
      const alreadyIn = liveSession2.participants.some(
  ...
  const endLiveClass = () => {
    ...
    const liveSession2 = db.liveClasses[sem];
    if (isRecording && liveSession2) {
      stopRecording(sem, liveSession2.title);
    }
    stopAllStreams();
    setDb((prev) => ({
      ...prev,
  ...
  const leaveRoom = () => {
    ...
    if (isRecording) {
      const sem = role === "teacher" ? selectedSemester : mySemester;
      const liveSession2 = db.liveClasses[sem];
      if (liveSession2) stopRecording(sem, liveSession2.title);
    }
    setInLiveRoom(false);
    setIsRecording(false);
    setMediaRecorder(null);
  ...
  const sendChat = () => {
    ...
    const msg = {
      id: `msg-${Date.now()}`,
      sender: role === "teacher" ? "Teacher" : (currentStudent == null ? void 0 : currentStudent.name) || "Student",
      role,
      text: chatInput.trim(),
    ...
    setDb((prev) => {
      ...
      return {
        ...
        liveClasses: {
          ...
          [sem]: {
            ...ls,
            participants: ls.participants.map(
              (p) => p.id === participantId ? { ...p, isMuted: !p.isMuted } : p
            )
          }
        }
      };
  ...
  if (booting) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-slate-950 text-white", children: "Loading…" });
  }
  if (!role) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-gradient-to-br from-slate-900 via-blue-950 to-indigo-900 px-4 py-8 md:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto grid max-w-6xl gap-6 lg:grid-cols-[1.1fr_0.9fr]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-[2rem] border border-white/10 bg-gradient-to-br from-slate-900/90 to-blue-900/80 p-8 text-white shadow-2xl backdrop-blur-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6 flex items-center gap-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold uppercase tracking-[0.25em] text-amber-400", children: "Private Law Education" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-blue-200", children: "Secure Academic Platform" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Pill, { tone: "gold", children: "Private Law Education Platform" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "mt-5 text-4xl font-bold leading-tight text-white md:text-5xl", children: "AtArani Law Academy" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 max-w-xl text-sm leading-6 text-blue-200 md:text-base", children: "A clean, premium, private study app for law students and teachers. Semester-based access, recorded classes, study materials, class routine, and teacher control in one simple interface." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 grid gap-3 sm:grid-cols-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-blue-400/20 bg-blue-400/10 p-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-bold text-blue-200", children: "Private" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-blue-300", children: "Login only" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-indigo-400/20 bg-indigo-400/10 p-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-bold text-indigo-200", children: "Mobile" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-blue-300", children: "Fast & simple" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 rounded-2xl border border-amber-400/30 bg-amber-500/15 p-4 text-sm text-amber-200", children: "⚠️ Screen recording, screenshot, or sharing of content is not allowed." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-[2rem] border border-slate-300 bg-white p-6 shadow-2xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-5 flex rounded-2xl bg-slate-100 p-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              "data-ocid": "login.teacher.tab",
              className: `flex-1 rounded-xl px-4 py-2 text-sm font-medium transition-all ${loginMode === "teacher" ? "bg-slate-900 text-white shadow" : "text-slate-600 hover:text-slate-800"}`,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              className: `flex-1 rounded-xl px-4 py-2 text-sm font-medium transition-all ${loginMode === "student" ? "bg-indigo-700 text-white shadow" : "text-slate-600 hover:text-slate-800"}`,
              onClick: () => setLoginMode("student"),
              children: "Student Login"
            }
          )
        ] }),
        loginMode === "teacher" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold text-slate-900", children: "Teacher access" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: "Enter as Teacher"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-slate-500", children: "Starter credentials are prefilled so you can enter first, adjust settings, and create student access." })
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold text-slate-900", children: "Student access" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-slate-500", children: "Students use the ID and code given by the teacher." })
        ] })
      ] })
    ] }) });
  }
  ...
  if (inLiveRoom && liveSession) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-screen flex-col bg-slate-900 text-white overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center gap-2 bg-amber-500 px-4 py-2 text-center text-xs font-semibold text-slate-900", children: "⚠️ Screen recording, screenshot, or sharing is not allowed" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3 border-b border-slate-700 bg-slate-800 px-4 py-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold text-white text-sm", children: liveSession.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-slate-400", children: [
              semesterLabel(liveSem),
              " • Started ",
              liveSession.startedAt
            ] })
          ] }),
          isRecording && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 rounded-full bg-red-900/60 px-3 py-1 text-xs font-semibold text-red-400", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block h-2 w-2 animate-pulse rounded-full bg-red-500" }),
            "REC"
          ] })
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 flex-col overflow-hidden", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 items-center justify-center gap-4 p-4 overflow-auto", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex-1 max-w-2xl", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-video w-full overflow-hidden rounded-2xl border border-slate-700 bg-slate-800", children: cameraOn ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                "video",
                {
                  ref: videoRef,
                  autoPlay: true,
              ...
              ) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-full w-full flex-col items-center justify-center gap-2 text-slate-500", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-5xl", children: "👤" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: "Camera off" })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-2 left-2 rounded-full bg-slate-900/80 px-3 py-1 text-xs text-white", children: role === "teacher" ? "Teacher (You)" : (currentStudent == null ? void 0 : currentStudent.name) || "You" })
            ] }),
            screenSharing && screenStream && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex-1 max-w-2xl", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-video w-full overflow-hidden rounded-2xl border border-blue-500 bg-slate-800", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "video",
                {
                  ref: screenRef,
                  autoPlay: true,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-2 left-2 rounded-full bg-blue-900/80 px-3 py-1 text-xs text-blue-300", children: "🖥️ Screen Share" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-slate-700 bg-slate-800/50 px-4 py-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-2 text-xs font-semibold uppercase tracking-wider text-slate-400", children: [
              "Participants (",
              liveSession.participants.length,
              ")"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: liveSession.participants.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: p.isMuted ? "🔇" : "🎤" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white", children: p.name }),
                  p.role === "teacher" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rounded-full bg-amber-600/30 px-1.5 py-0.5 text-xs text-amber-400", children: "Teacher" }),
                  role === "teacher" && p.role === "student" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        type: "button",
                        ...
                        children: p.isMuted ? "Unmute" : "Mute"
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-center gap-3 border-t border-slate-700 bg-slate-800 px-4 py-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                className: `flex flex-col items-center gap-1 rounded-2xl px-4 py-3 text-xs font-medium transition ${cameraOn ? "bg-blue-600 text-white" : "bg-slate-700 text-slate-300 hover:bg-slate-600"}`,
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl", children: cameraOn ? "📷" : "📵" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: cameraOn ? "Camera On" : "Camera Off" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                onClick: toggleMic,
                className: `flex flex-col items-center gap-1 rounded-2xl px-4 py-3 text-xs font-medium transition ${micOn ? "bg-blue-600 text-white" : "bg-slate-700 text-slate-300 hover:bg-slate-600"}`,
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl", children: micOn ? "🎤" : "🔇" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: micOn ? "Mic On" : "Mic Off" })
                ]
              }
            ),
            role === "teacher" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                type: "button",
                "data-ocid": "liveclass.screen_share.toggle",
                onClick: toggleScreenShare,
                className: `flex flex-col items-center gap-1 rounded-2xl px-4 py-3 text-xs font-medium transition ${screenSharing ? "bg-blue-600 text-white" : "bg-slate-700 text-slate-300 hover:bg-slate-600"}`,
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl", children: "🖥️" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: screenSharing ? "Stop Share" : "Share Screen" })
                ]
              }
            ),
            role === "teacher" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                onClick: isRecording ? () => stopRecording(liveSem, liveSession.title) : startRecording,
                className: `flex flex-col items-center gap-1 rounded-2xl px-4 py-3 text-xs font-medium transition ${isRecording ? "bg-red-700 text-white" : "bg-slate-700 text-slate-300 hover:bg-slate-600"}`,
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl", children: "⏺️" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: isRecording ? "Stop Rec" : "Record" })
                ]
              }
            )
          ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-slate-700 px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold text-sm text-white", children: "💬 Class Chat" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto p-3 space-y-2", children: [
                liveSession.chat.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                ...
                liveSession.chat.map((msg) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    className: `rounded-2xl p-3 text-sm ${msg.role === "teacher" ? "bg-amber-600/20 border border-amber-500/30" : "bg-slate-700"}`,
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 mb-1", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-xs text-white", children: msg.sender }),
                        msg.role === "teacher" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-amber-400", children: "(Teacher)" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto text-xs text-slate-500", children: msg.time })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-slate-200 leading-relaxed", children: msg.text })
                    ]
                  },
                  msg.id
                )),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-slate-700 p-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-slate-50 text-slate-900", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-20 border-b border-slate-700 bg-slate-900 shadow-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-3 px-4 py-3 md:px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-bold uppercase tracking-[0.2em] text-amber-400", children: "AtArani Law Academy" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-400", children: "Private study platform" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Pill, { tone: "gold", children: role === "teacher" ? "Teacher" : `Student • ${semesterLabel(mySemester)}` }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            ...
            children: semesterLabel(semesterView)
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "mx-auto max-w-7xl px-4 py-6 md:px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mb-6 grid gap-4 lg:grid-cols-[1.2fr_0.8fr]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Card,
          {
            title: "Welcome",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Pill, { tone: "blue", children: "Semester-based access" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Pill, { tone: "gold", children: "Recorded classes" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Pill, { tone: "slate", children: "PDF notes" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Pill, { tone: "slate", children: "Class routine" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 max-w-2xl text-sm leading-6 text-slate-600", children: role === "teacher" ? "As teacher, you can change semester codes, add students, upload videos/notes, and manage content by semester." : "You can only view your own semester content. Other semester materials stay hidden from your dashboard." })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Card,
          {
            ...
            accent: "amber",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl border border-amber-300 bg-amber-50 p-4 text-sm font-medium text-amber-900", children: "⚠️ Screen recording, screenshot, or sharing of content is not allowed." })
          }
        )
      ] }),
      ...
      activeTab === "dashboard" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 lg:grid-cols-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Card,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Pill, { tone: "gold", children: semesterLabel(semesterView) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Pill, { tone: "blue", children: [
                "Code: ",
                db.semesterCodes[semesterView]
              ] })
            ] })
          }
        ),
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-3 sm:grid-cols-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  children: "Open Recorded Classes"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
      ...
      activeTab === "routine" && /* @__PURE__ */ jsxRuntimeExports.jsx(
        Card,
        {
          title: `${semesterLabel(semesterView)} Routine`,
          subtitle: "Class schedule for the selected semester.",
          accent: "blue",
          children: semesterRoutine.length ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-3", "data-ocid": "routine.list", children: semesterRoutine.map((item, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold text-slate-900", children: item.subject }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-slate-500", children: item.topic })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 text-sm", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Pill, { tone: "slate", children: item.day }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Pill, { tone: "blue", children: item.time })
                ] })
              ]
            },
            `${item.subject}-${idx}`
            ...
            "div",
            {
              ...
              children: "No routine added yet."
            }
          )
        }
      ),
      activeTab === "classes" && /* @__PURE__ */ jsxRuntimeExports.jsx(
        Card,
        {
          title: `${semesterLabel(semesterView)} Recorded Classes`,
          subtitle: "Subject → Chapter → Video.",
          accent: "blue",
          children: semesterRecordings.length ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-3", "data-ocid": "classes.list", children: semesterRecordings.map((item, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-start justify-between gap-3", children: [
                ...
                ) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rounded-full bg-slate-100 px-4 py-2 text-sm text-slate-500", children: "Link not added" })
              ] })
            },
            `${item.subject}-${idx}`
          )) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              className: "text-sm text-slate-500",
              children: "No recorded class added yet."
            }
          )
        }
      ),
      activeTab === "materials" && /* @__PURE__ */ jsxRuntimeExports.jsx(
        Card,
        {
          title: `${semesterLabel(semesterView)} Study Materials`,
          subtitle: "PDFs, notes, and downloads.",
          accent: "purple",
          children: semesterMaterials.length ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-3", "data-ocid": "materials.list", children: semesterMaterials.map((item, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold text-slate-900", children: item.subject }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-slate-500", children: item.title })
                ] }),
                item.url ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "a",
                  {
                    ...
                    children: item.type === "PDF" ? "Open / Download" : "Open"
                  }
                ) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rounded-full bg-slate-100 px-4 py-2 text-sm text-slate-500", children: "Link not added" })
              ] })
            },
            ...
            "div",
            {
              ...
              className: "text-sm text-slate-500",
              children: "No study material added yet."
            }
          )
        }
      ),
      activeTab === "students" && /* @__PURE__ */ jsxRuntimeExports.jsx(
        Card,
        {
          title: `${semesterLabel(semesterView)} Students`,
          subtitle: "Students only see their own semester content.",
          accent: "emerald",
          children: db.students.filter((s) => s.semester === semesterView).length ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-3", "data-ocid": "students.list", children: db.students.filter((s) => s.semester === semesterView).map((s, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold text-slate-900", children: s.name }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm text-slate-500", children: [
                    "ID: ",
                    s.id
                  ] })
            ...
            "div",
            {
              ...
              className: "text-sm text-slate-500",
              children: "No student added for this semester yet."
            }
          )
        }
      ),
      activeTab === "liveclass" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", "data-ocid": "liveclass.section", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl border border-amber-300 bg-amber-50 p-4 text-sm font-medium text-amber-900", children: "⚠️ Screen recording, screenshot, or sharing is not allowed during live classes." }),
        role === "teacher" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          Card,
          {
            ...
            accent: "blue",
            children: !liveSession ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border-2 border-slate-100 bg-slate-50 p-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-3 text-sm font-semibold text-slate-700", children: "No active session for this semester." }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border-2 border-emerald-200 bg-emerald-50 p-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block h-3 w-3 animate-pulse rounded-full bg-red-500" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-semibold text-emerald-900", children: [
                    "Live: ",
                    liveSession.title
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(Pill, { tone: "gold", children: [
                    "Started ",
                    liveSession.startedAt
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 text-sm text-emerald-700", children: [
                  liveSession.participants.length,
                  " participant(s) in room"
                ] })
              ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Card,
            {
              ...
              accent: "blue",
              children: liveSession ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border-2 border-emerald-200 bg-emerald-50 p-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block h-3 w-3 animate-pulse rounded-full bg-red-500" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-semibold text-emerald-900", children: [
                ...
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium text-slate-700", children: "No live class currently." }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 text-sm text-slate-500", children: "Check back later — your teacher will start a session soon." })
                  ]
                }
              )
            }
      ...
      role === "teacher" && activeTab === "teacher" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 xl:grid-cols-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Card,
          {
            ...
            accent: "amber",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-h-[620px] space-y-3 overflow-auto pr-1", children: SEMESTERS.map((sem) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                className: "grid gap-2 rounded-2xl border-2 border-slate-100 p-4 md:grid-cols-[160px_1fr] md:items-center",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium text-slate-800", children: semesterLabel(sem) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                      className: "w-full rounded-2xl border-2 border-slate-200 px-4 py-3 outline-none transition focus:border-amber-500 focus:ring-2 focus:ring-amber-100",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Card,
            {
              ...
              accent: "blue",
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-3 md:grid-cols-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "select",
                    {
                      ...
                      children: SEMESTERS.map((sem) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: sem, children: semesterLabel(sem) }, sem))
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Card,
            {
              ...
              accent: "purple",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-4 flex flex-wrap gap-2", children: SEMESTERS.map((sem) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
                    onClick: () => setSelectedSemester(sem),
                    className: `rounded-full px-3 py-2 text-sm font-medium transition ${selectedSemester === sem ? "bg-indigo-700 text-white shadow" : "bg-slate-100 text-slate-700 hover:bg-indigo-50 hover:text-indigo-700"}`,
                    children: sem
                  },
                  sem
                )) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border-2 border-slate-100 bg-slate-50 p-4", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-3 font-semibold text-slate-800", children: "Add routine" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-3 md:grid-cols-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "input",
                        {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border-2 border-slate-100 bg-slate-50 p-4", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-3 font-semibold text-slate-800", children: "Add recorded class" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-3 md:grid-cols-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "input",
                        {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border-2 border-slate-100 bg-slate-50 p-4", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-3 font-semibold text-slate-800", children: "Add study material" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-3 md:grid-cols-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "input",
                        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "mt-12 border-t border-slate-200 bg-slate-900 py-6 text-center text-sm text-slate-400", children: [
      "© ",
